...
int s21_is_greater_or_equal(s21_decimal value_1, s21_decimal value_2) {
  ...
  if (sign_1 != sign_2) {
    ...
    value = sign_1 ? (s21_mantisa_compare_big(value_big_2, value_big_1) != 0)
                   : (s21_mantisa_compare_big(value_big_1, value_big_2) != 0);
  }
  return value;
}
...
int s21_is_greater_or_equal_big(s21_big_decimal value_1,
  ...
  if (sign_1 != sign_2) {
    ...
    value = sign_1 ? (s21_mantisa_compare_big(value_2, value_1) != 0)
                   : (s21_mantisa_compare_big(value_1, value_2) != 0);
  }
  return value;
}