...
void hubert_furr_tests(SRunner *runner) {
  ...
  // srunner_add_suite(runner, mod_suite0());
  // srunner_add_suite(runner, mod_suite1());
  // srunner_add_suite(runner, mod_suite2());
  // srunner_add_suite(runner, mod_suite3());
  // srunner_add_suite(runner, mod_suite4());
  // srunner_add_suite(runner, mod_suite5());
  // srunner_add_suite(runner, mod_suite6());
  // srunner_add_suite(runner, mod_suite7());
  // srunner_add_suite(runner, mod_suite8());
  // srunner_add_suite(runner, mod_suite9());
  // srunner_add_suite(runner, mod_suite10());
  // srunner_add_suite(runner, mod_suite11());
  // srunner_add_suite(runner, mod_suite12());
  // srunner_add_suite(runner, mod_suite13());
  // srunner_add_suite(runner, mod_suite14());
  // srunner_add_suite(runner, mod_suite15());
  // srunner_add_suite(runner, mod_suite16());
  // srunner_add_suite(runner, mod_suite17());
  // srunner_add_suite(runner, mod_suite18());
